...
# CONFIG register
    ...
    def getExternalFrameSync(self):
         ...
         * Sampling Rate, defined in register 25. After sampling, latch will
...
# ACCEL_CONFIG register
    ...
    def getFullScaleAccelRange(self):
         ...
         * sensors, described in the table below.
         *
         * <pre>
         0 = +/- 2g
         1 = +/- 4g
     ...
     * Fall, threshold, Zero Motion). The high pass filter output is not
     ...
     *
     *    Hold:  When triggered, filter holds the present sample. The filter
...
# FF_THR register
    ...
    def getFreefallDetectionThreshold(self):
         ...
         * detection. The unit of FF_THR 1LSB = 2mg. Free Fall is detected when the
         * absolute value of the accelerometer measurements for the three axes are each
         * less than the detection threshold. This condition increments the Free Fall
         * duration counter (Register 30). The Free Fall interrupt is triggered when the
         * Free Fall duration counter reaches the time specified in FF_DUR.
         *
         * For more details on the Free Fall detection interrupt, Section 8.2 of the
...
# FF_DUR register
    ...
    def getFreefallDetectionDuration(self):
         ...
         * detection. The duration counter ticks at 1kHz, FF_DUR has a unit
         * of LSB = 1 ms.
         *
         * The Free Fall duration counter increments while the absolute value of the
         * accelerometer measurements are each less than the detection threshold
         * (Register 29). The Free Fall interrupt is triggered when the Free Fall
         * duration counter reaches the time specified in self register.
         *
         * For more details on the Free Fall detection interrupt, Section 8.2 of
         * the MPU-6000/MPU-6050 Product Specification document as well as Registers 56
         * and 58 of self document.
         *
...
# MOT_THR register
    ...
    def getMotionDetectionThreshold(self):
         ...
         * generation. The unit of MOT_THR 1LSB = 2mg. Motion is detected when the
         * absolute value of any of the accelerometer measurements exceeds self Motion
         ...
         *
         * For more details on the Motion detection interrupt, Section 8.3 of the
         * MPU-6000/MPU-6050 Product Specification document as well as Registers 56 and
         * 58 of self document.
         *
...
# MOT_DUR register
    ...
    def getMotionDetectionDuration(self):
         ...
         * generation. The duration counter ticks at 1 kHz, MOT_DUR has a unit
         * 1LSB = 1ms. The Motion detection duration counter increments when the
...
# ZRMOT_THR register
    ...
    def getZeroMotionDetectionThreshold(self):
         ...
         * generation. The unit of ZRMOT_THR 1LSB = 2mg. Zero Motion is detected when
         ...
         * longer detected.
         *
         * When a zero motion event is detected, Zero Motion Status will be indicated
         * in the MOT_DETECT_STATUS register (Register 97). When a motion-to-zero-motion
         * condition is detected, status bit is set to 1. When a zero-motion-to-
         * motion condition is detected, status bit is set to 0.
         *
         * For more details on the Zero Motion detection interrupt, Section 8.4 of
         * the MPU-6000/MPU-6050 Product Specification document as well as Registers 56
         * and 58 of self document.
         *
...
# ZRMOT_DUR register
    ...
    def getZeroMotionDetectionDuration(self):
         ...
         * ZRMOT_DUR has a unit of LSB = 64 ms. The Zero Motion duration counter
         * increments while the absolute value of the accelerometer measurements are
         * each less than the detection threshold (Register 33). The Zero Motion
         * interrupt is triggered when the Zero Motion duration counter reaches the time
         * count specified in self register.
         *
         * For more details on the Zero Motion detection interrupt, Section 8.4 of
         * the MPU-6000/MPU-6050 Product Specification document, well as Registers 56
         * and 58 of self document.
         *
...
# FIFO_EN register
    ...
    def getTempFIFOEnabled(self):
         ...
         * When set to 1, bit enables TEMP_OUT_H and TEMP_OUT_L (Registers 65 and
    ...
    def getXGyroFIFOEnabled(self):
         ...
         * When set to 1, bit enables GYRO_XOUT_H and GYRO_XOUT_L (Registers 67 and
    ...
    def getYGyroFIFOEnabled(self):
         ...
         * When set to 1, bit enables GYRO_YOUT_H and GYRO_YOUT_L (Registers 69 and
         * 70) to be written into the FIFO buffer.
         * @return Current gyroscope Y-axis FIFO enabled value
         * @see MPU6050_RA_FIFO_EN
         '''
        return self.readBit(devAddr, MPU6050_RA_FIFO_EN, MPU6050_YG_FIFO_EN_BIT)
    ...
    def getZGyroFIFOEnabled(self):
         ...
         * When set to 1, bit enables GYRO_ZOUT_H and GYRO_ZOUT_L (Registers 71 and
         * 72) to be written into the FIFO buffer.
         * @return Current gyroscope Z-axis FIFO enabled value
         * @see MPU6050_RA_FIFO_EN
         '''
        return self.readBit(devAddr, MPU6050_RA_FIFO_EN, MPU6050_ZG_FIFO_EN_BIT)
    ...
    def getSlave2FIFOEnabled(self):
         ...
         * When set to 1, bit enables EXT_SENS_DATA registers (Registers 73 to 96)
...
# I2C_MST_CTRL register
    ...
    def getMultiMasterEnabled(self):
         ...
         * bus. In circuits where multi-master capability is required, MULT_MST_EN
         * to 1. This will increase current drawn by approximately 30uA.
         *
         * In circuits where multi-master capability is required, state of the I2C
         * bus must always be monitored by each separate I2C Master. Before an I2C
         * Master can assume arbitration of the bus, must first confirm that no other
         * I2C Master has arbitration of the bus. When MULT_MST_EN is set to 1, the
         * MPU-60X0's bus arbitration detection logic is turned on, it to
    ...
    def getSlaveReadWriteTransitionEnabled(self):
         ...
         * read to the next slave read. If the bit equals 0, will be a restart
         * between reads. If the bit equals 1, will be a stop followed by a start
...
# I2C_SLV* registers (Slave 0-3)
    ...
    def getSlaveAddress(self, num):
         ...
         * read results, refer to the EXT_SENS_DATA register description
         * (Registers 73 - 96).
         *
         * The MPU-6050 supports a total of five slaves, Slave 4 has unique
         * characteristics, so it has its own functions (getSlave4* and setSlave4*).
         *
         ...
         * processing the slaves is Slave 0, 1, 2, 3 and Slave 4. If a
         * particular Slave is disabled it will be skipped.
         *
         * Each slave can either be accessed at the sample rate or at a reduced sample
         * rate. In a case where some slaves are accessed at the Sample Rate and some
         * slaves are accessed at the reduced rate, sequence of accessing the slaves
         * (Slave 0 to Slave 4) is still followed. However, reduced rate slaves will
         * be skipped if their access rate dictates that they should not be accessed
         * during that particular cycle. For further information regarding the reduced
         * access rate, refer to Register 52. Whether a slave is accessed at the
         ...
         * @see MPU6050_RA_I2C_SLV0_ADDR
         '''
        if (num > 3) : return 0 
        return self.bus.read_byte_data(devAddr, MPU6050_RA_I2C_SLV0_ADDR + num*3)
    ...
    def getSlaveRegister(self, num):
         ...
         * @see MPU6050_RA_I2C_SLV0_REG
         '''
        if (num > 3) : return 0
        return self.bus.read_byte_data(devAddr, MPU6050_RA_I2C_SLV0_REG + num*3)
    ...
    def setSlaveRegister(self, num, reg):
         ...
         * @see MPU6050_RA_I2C_SLV0_REG
         '''
        if (num > 3) : return
        self.bus.write_byte_data(devAddr, MPU6050_RA_I2C_SLV0_REG + num*3, reg)

    def getSlaveEnabled(self, num):
        '''* Get the enabled value for the specified slave (0-3).
         * When set to 1, bit enables Slave 0 for data transfer operations. When
         * cleared to 0, bit disables Slave 0 from data transfer operations.
         * @param num Slave number (0-3)
    ...
    def getSlaveWordByteSwap(self, num):
         ...
         * When set to 1, bit enables byte swapping. When byte swapping is enabled,
    ...
    def getSlaveWordGroupOffset(self, num):
         ...
         * When cleared to 0, from register addresses 0 and 1, and 3, etc (even,
         * then odd register addresses) are paired to form a word. When set to 1, bytes
         * from register addresses are paired 1 and 2, and 4, etc. (odd, even
    ...
    def getSlaveDataLength(self, num):
         ...
         * Specifies the number of bytes transferred to and from Slave 0. Clearing self
